...
namespace mellohi
{
    ...
    inline ButtonModifier operator|(ButtonModifier lhs, ButtonModifier rhs)
    {
        using T = std::underlying_type_t<ButtonModifier>;
        return static_cast<ButtonModifier>(static_cast<T>(lhs) | static_cast<T>(rhs));
    }

    inline ButtonModifier & operator|=(ButtonModifier &lhs, const ButtonModifier rhs)
    {
        lhs = lhs | rhs;
        return lhs;
    }
